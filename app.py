...
# OpenAI API кілтіңді осында жаз
...
# Flan-T5 моделін жүктейміз
model_name = "google/flan-t5-small"
tokenizer = AutoTokenizer.from_pretrained(model_name)
model = AutoModelForSeq2SeqLM.from_pretrained(model_name)

# Flan-T5 генерациялау функциясы
def generate_task_flan(topic, task_format, difficulty, language):
    prompt = (f"Generate 1 {task_format} educational task on the topic '{topic}'. "
...
# OpenAI арқылы генерациялау функциясы
